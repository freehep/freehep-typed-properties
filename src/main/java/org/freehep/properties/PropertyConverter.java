...
public interface PropertyConverter<T> {
    /**
     * Store property with key, typename and value in p. You would normally
     * need to convert value to String and maybe do something to the key.
     * 
     * @param p
     ...
     * convert value to typeName's type and then store it under key. If key
     * has some special meaning you may need to act on it.
     * 
     * @param properties
