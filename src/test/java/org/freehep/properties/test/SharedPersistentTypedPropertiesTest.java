...
public class SharedPersistentTypedPropertiesTest {
	...
	public static void readFile() {
		...
		properties1 = new PersistentTypedProperties(setPropertiesFile, null,
				false, 1000);
		properties2 = new PersistentTypedProperties(setPropertiesFile, null,
				false, 1000);
	}
	...
	public void testSharedList() throws InterruptedException {
		properties1.set("StringList", Arrays.asList(new String[] { "One",
				"Two", "Three" }));
		while (properties2.get("StringList", null) == null) {
			Thread.sleep(500);
		}
		org.junit.Assert.assertEquals(properties2.get("StringList", (List<String>) null)
				.get(1), "Two");
	}
}
