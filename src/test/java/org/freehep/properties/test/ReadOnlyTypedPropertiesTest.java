...
public class ReadOnlyTypedPropertiesTest {
    ...
    public void getFileName() {
        Assert.assertEquals(new File("TestFileName"), properties.get("FileName", (File)null));
    }
    
    @Test 
    public void getFileList() {
        Assert.assertEquals(Arrays.asList(new File[] {new File("SimpleName.ext"), new File("SimpleName2.ext"), new File("SimpleName3.ext")}), properties.get("FileList", (List<File>)null));
    }
